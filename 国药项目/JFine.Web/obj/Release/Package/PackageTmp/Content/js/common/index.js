                ...
                $.each(childNodes, function (i) {
                    ...
                    if (subChildNodes.length > 0) {
                        ...
                        $.each(subChildNodes, function (i) {
                            ...
                            _html += '<li><a class="menuItem" data-id="' + subChildNodesRow.Id + '" href="' + subChildNodesRow.UrlAddress + '" data-index="' + subChildNodesRow.Sort + '"><i class="' + subChildNodesRow.Icon + '"></i>' + subChildNodesRow.Name + '</a></li>';
                        });
                        _html += '</ul>';
                    } else {
                        _html += '<a class="menuItem" data-id="' + subrow.Id + '" href="' + subrow.UrlAddress + '" data-index="' + subrow.Sort + '"><i class="' + subrow.Icon + '"></i>' + subrow.Name + '</a>';
                    }
                   _html += '</li>';
                });
                _html += '</ul>';
