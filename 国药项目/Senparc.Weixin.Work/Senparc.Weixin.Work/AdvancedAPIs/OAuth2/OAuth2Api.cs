...
namespace Senparc.Weixin.Work.AdvancedAPIs
{
    ...
    public static class OAuth2Api
    {
        ...
        public static string GetCode(string corpId, string redirectUrl, string state, string agentId, string responseType = "code", string scope = "snsapi_base")
        {
            ...
            var url = string.Format("https://open.weixin.qq.com/connect/oauth2/authorize?appid={0}&redirect_uri={1}&response_type={2}&scope={3}{4}&state={5}&connect_redirect=1#wechat_redirect", corpId.AsUrlData(), redirectUrl.AsUrlData(), responseType.AsUrlData(), scope.AsUrlData(), agendIdValue, state.AsUrlData());
