...
{	
	...
	/// GY_CJBLL
	/// </summary>	
	public class GY_CJBLL
	{
	    private IGY_CJRepository service=new GY_CJRepository();

		/// <summary>
        /// 缓存key
        /// </summary>
        public string cacheKey ="GY_CJCache" ;
        ...
        /// <returns></returns>
        public IEnumerable<GY_CJEntity> GetPageListBySql(Pagination pagination, string queryJson)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public IEnumerable<GY_CJEntity> GetList( string queryJson)
        {
             var expression = LinqExtensions.True<GY_CJEntity>();
            var queryParam = queryJson.ToJObject();
            //查询条件
        ...
        /// <param name="queryJson">查询参数</param>
        /// <returns></returns>
        public IEnumerable<GY_CJEntity> GetPageList(Pagination pagination, string queryJson)
        {
			var expression = LinqExtensions.True<GY_CJEntity>();
            var queryParam = queryJson.ToJObject();
             //查询条件
        ...
        public void SaveForm(string keyValue, GY_CJEntity gY_CJEntity)
        {
            try
            {
                service.SaveForm(keyValue, gY_CJEntity);
                CacheFactory.Cache().WriteCache(cacheKey,gY_CJEntity);
            }
            catch (Exception)
            {
                throw;
