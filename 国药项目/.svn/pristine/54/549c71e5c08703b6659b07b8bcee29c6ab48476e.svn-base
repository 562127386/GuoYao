...
{	
	...
	/// GY_SCTG_DBLL
	/// </summary>	
	public class GY_SCTG_DBLL
	{
	    private IGY_SCTG_DRepository service=new GY_SCTG_DRepository();

		/// <summary>
        /// 缓存key
        /// </summary>
        public string cacheKey ="GY_SCTG_DCache" ;
        ...
        /// <returns></returns>
        public IEnumerable<GY_SCTG_DEntity> GetPageListBySql(Pagination pagination, string queryJson)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public IEnumerable<GY_SCTG_DEntity> GetList( string queryJson)
        {
             var expression = LinqExtensions.True<GY_SCTG_DEntity>();
            var queryParam = queryJson.ToJObject();
            //查询条件
        ...
        /// <param name="queryJson">查询参数</param>
        /// <returns></returns>
        public IEnumerable<GY_SCTG_DEntity> GetPageList(Pagination pagination, string queryJson)
        {
            var expression = LinqExtensions.True<GY_SCTG_DEntity>();
            var queryParam = queryJson.ToJObject();
            //查询条件
        ...
        public void SaveForm(string keyValue, GY_SCTG_DEntity gY_SCTG_DEntity)
        {
            try
            {
                service.SaveForm(keyValue, gY_SCTG_DEntity);
                CacheFactory.Cache().WriteCache(cacheKey,gY_SCTG_DEntity);
            }
            catch (Exception)
            {
                throw;
